...
namespace GameOfLife.Archive
{
    //Memento caretaker
    /// <summary> 
    /// Класс, отвечающий за хранения состояний объекта
    /// </summary>
    class FieldArchive
    {
        /// <summary>
        /// Список снимков состояний field
        /// </summary>
        ...
        /// <summary>
        /// Добавляет новый снимок состояния объекта field
        /// </summary>
        ...
        /// <summary>
        /// Смотрит, содержится ли состояние объекта field в списке состояний
        /// </summary>
